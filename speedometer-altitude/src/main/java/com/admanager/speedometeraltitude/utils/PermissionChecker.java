package com.admanager.speedometeraltitude.utils;
...
public class PermissionChecker {
    private static final String TAG = "SpeedoMeter&Altitude";
    ...
    public void checkPermissionGrantedAndRun(@NonNull Runnable runnable) {
        ...
        boolean permissionGranted =
                preM || ContextCompat.checkSelfPermission(activity, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED
