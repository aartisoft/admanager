...
public class CustomArtistsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int CONTENT_TYPE = 0;
    private final Context context;
    private final MPCustomItemClickListener listener;
    private List<Track> rowItems;

    public CustomArtistsListAdapter(Context context, final List<Track> rowTrackItems, MPCustomItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull final ViewGroup viewGroup, int viewType) {
        View itemLayoutView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mp_list_artists, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        List<Track> trackList = GetTracks.getAllTracksForArtist(context, track.getArtistId());
        int totalTrackNo = 0;
        if (trackList != null) {
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemLayoutView) {
            ...
            View mlArtistLayout = itemLayoutView.findViewById(R.id.mlArtistLayout);
            ...
            mlArtistLayout.setOnClickListener(onClickListener);
