 ...
 * Use the {@link MPTracksFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MPTracksFragment extends Fragment {
    ...
    public static MPTracksFragment newInstance(String param1) {
        MPTracksFragment fragment = new MPTracksFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.mp_fragment_tracks, container, false);

        RecyclerView faRecyclerViewList = view.findViewById(R.id.tfListViewMusic);
    ...
    private void loadTracksAsyncTask() {
        ...
        List<Track> trackList = GetTracks.getAllTracks(getContext(), query);
